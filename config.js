module.exports = {
  cmdPerPage: 20, //Number of commands per page of help command
  adminId: "173946006684041216", // Admin of the bot
  token: process.env.token || "OTM5MjM2OTYxNjExMzEzMjMz.GF9Ifh.XuXUjykqfI_0ssoArG9gKPhbQizaV-CyAi60Ak", //Bot's Token
  clientId: process.env.clientId || "939236961611313233", //ID of the bot
  clientSecret: process.env.clientSecret || "b0CRXg7bh1R8AFhiVhruxJJ1F1N0baJ5", //Client Secret of the bot
  port: 4200, //Port of the API and Dashboard
  scopes: ["identify", "guilds", "applications.commands"], //Discord OAuth2 Scopes
  serverDeafen: true, //If you want bot to stay deafened
  defaultVolume: 100, //Sets the default volume of the bot, You can change this number anywhere from 1 to 100
  supportServer: "https://discord.gg/PNEhhsy", //Support Server Link
